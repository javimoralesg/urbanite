 ...
 * 
 * This `fsm_ultrasound_t` is the ultrasound structure.
 * 
 */
 ...
 * 
 * @param p_fsm Pointer to an `fsm_ultrasound_t` structure.

 */
void 	fsm_ultrasound_destroy (fsm_ultrasound_t *p_fsm);

/**
 * @brief Return the distance of the last object detected by the ultrasound sensor.
 * 
 ...
 * 
 * `true` means that the ultrasound sensor is active and a distance measurement must be performed. `false` means that the ultrasound sensor is inactive.
 * 
 * @param p_fsm Pointer to an `fsm_ultrasound_t` structure.
 ...
 * 
 * @param p_fsm Pointer to a `fsm_ultrasound_t` structure.
